...
import com.talentnetwork.service.DownloadService;
import com.talentnetwork.service.DownloadService.DownloadBinder;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btn_cancel.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				finish();
				Intent intent = new Intent(NotificationUpdateActivity.this,MainActivity
						.class);
